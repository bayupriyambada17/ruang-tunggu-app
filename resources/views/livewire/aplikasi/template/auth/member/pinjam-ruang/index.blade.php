...
<div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <label class="form-label">Penjelasan meminjam</label>
    ...
    <button type="button" class="btn btn-primary btn-md mt-2" wire:click.prevent="saveForm()">Lakukan Transaksi</button>
</div>
